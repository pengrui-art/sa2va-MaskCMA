...
class OspreyDataset(Dataset):
    ...
    def _process_conversation(self, converations, n_regions, region_pixels):
        start_region_str = "<image> There are {} part regions in the picture: ".format(
            n_regions
        )
    ...
    def dataset_map_fn(self, data_dict):
        ...
        conversations = self._process_conversation(
    ...
    def __getitem__(self, index):
        ...
        # parse datasets
        result = self.dataset_map_fn(
            data_dict
        )  # {'image', 'height', 'width', 'conversation', 'masks'}
